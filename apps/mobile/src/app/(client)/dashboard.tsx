...
export default function Dashboard() {
    ...
    const displayName = authState.user?.fullName ?? authState.user?.email ?? 'Guest';
...
async function loadDashboard() {
    ...
    return {
        ...
        state: {
            bookingsPage: bookings.status === 'fulfilled' ? normalizeBookingsPage(bookings.value) : null,
...
function normalizeBookingsPage(bookingsPage: ClientBookingsPage): ClientBookingsPage {
    return {
        ...bookingsPage,
        inactiveBookings: Array.isArray(bookingsPage.inactiveBookings) ? bookingsPage.inactiveBookings : [],
    };
}
